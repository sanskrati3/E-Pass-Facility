...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
       ...
       <table id="t01">
        ...
        <%
            ...
            ps=  conn.prepareStatement("select name,emailaddress,password,contact,id,department from student_registered where id=?");          
            ps.setString(1, id2);           
            rs = ps.executeQuery();           
            if(rs.next())
            {
  ...
  <tr><td >EMAIL ID OF THE STUDENT</td>  <td><%=rs.getString("emailaddress") %></td> </tr>                      
 <tr><td>PASSWORD OF THE STUDENT</td><td><%=rs.getString("password") %> </td></tr>
...
<div style="margin-top: 70px;font-size: 20px"> <a href="home.jsp" class="previous" style=" display: inline-block; padding: 8px 16px; background-color: #4CAF50;
