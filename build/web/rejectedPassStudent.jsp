  ...
  <body>        <table  border="2" id="myTable" >
	...
	<th style="background-color: #4CAF50; color:white" align="center">REASON </th>
        ...
        Connection con = null;
            ...
            ps=  conn.prepareStatement("select gatepsno,id,name,department,contact,reason_for_pass from epass where status='rejected' and id=?");
              ps.setString(1,id1);
             rs = ps.executeQuery(); 
            while(rs.next()){
                  count++;
...
{%>
   ...
   <th style="background-color: red; color:white" colspan=6 align="center">sorry!!  &#128517 you have no rejected passes.</th>
<% }
            }
