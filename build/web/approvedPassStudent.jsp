...
function closeNav() {
  ...
  <body>        <table  border="2" id="myTable" >
          <center>      <h1>LIST OF APPROVED GATE PASSES</h1></center>
    <tr>
        <th style="background-color: #4CAF50; color:white" align="center">NAME </th>
        <th style="background-color: #4CAF50; color:white" align="center">GATE-PASS NUMBER</th>
	...
	<th style="background-color: #4CAF50; color:white" align="center">REASON</th>
        ...
        Connection con = null;
            ...
            ps=  conn.prepareStatement("select id,name,gatepsno,department,contact,reason_for_pass from epass where status='approved'and id=?");
            ps.setString(1,id1);
             rs = ps.executeQuery(); 
            while(rs.next()){
                count++;
...
{%>
   ...
   <th style="background-color: red; color:white" colspan=6 align="center">sorry!!  &#128517 you have no approved passes.</th>
<% }
            }
