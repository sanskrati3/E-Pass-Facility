...
public final class loginStudent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Login Page</title> </head>\n");
      out.write("  \n");
      out.write("        ");
    ...
    ResultSet rs;
    rs = st.executeQuery("select * from s_register where s_enroll='" + u_enroll + "' and s_pass='" + u_pass + "'");
    if (rs.next()) {    
        String s_enroll=rs.getString("s_enroll");  
        System.out.println("sending"+s_enroll);
        session.setAttribute("enroll",s_enroll); 
